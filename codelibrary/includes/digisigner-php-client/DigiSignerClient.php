...
class DigiSignerClient {
	 ...
	 * @return 
	 */
	# friend function would be greats
	public function getDocumentFairplane($document_id, $dest_file_path)
	{
		$val = $this->getRequest()->getFileResponse($document_id, $dest_file_path);
